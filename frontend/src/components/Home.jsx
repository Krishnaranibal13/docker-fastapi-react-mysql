...
import { Card, Button, message, Form, Input, Result } from 'antd';
...
const Home = () => {
    ...
    const handleSubscribe = async (e) => {
        ...
        try {
            ...
            messageApi.error('Subscription failed');
        }
    };
    return (
        <div className="home">
            ...
            <div className="hero">
                <div>
                    <h1>Unlock the power <br /> of customer <br /> experiences</h1>
                    <p>Build lasting relationship with our complete customer service Solution.</p>
                ...
                <svg width="254" height="294">
                    ...
                    <g fill="none" fill-rule="evenodd">
                        <g transform="translate(0 .067)"><mask fill="#fff"></mask>
                        <path d="M0 128.134v-2.11C0 56.608 56.273.334 125.69.334h2.11c69.416 0 125.69 56.274 125.69 125.69v2.11c0 69.417-56.274 125.69-125.69 125.69h-2.11C56.273 253.824 0 197.551 0 128.134" fill="#E4EBF7" mask="url(#b)"></path></g>
                        ...
                        <path d="M101.22 76.514c-.104.613-.585 1.044-1.076.96-.49-.082-.805-.646-.702-1.26.104-.613.585-1.044 1.076-.961.491.083.805.647.702 1.26M94.26 75.074c-.104.613-.585 1.044-1.076.96-.49-.082-.805-.646-.702-1.26.104-.613.585-1.044 1.076-.96.491.082.805.646.702 1.26" fill="#552950"></path><path stroke="#DB836E" stroke-width="1.063" stroke-linecap="round" stroke-linejoin="round" d="M99.206 73.644l-.9 1.62-.3 4.38h-2.24"></path>
                        ...
                        <path d="M237.824 212.977a4.813 4.813 0 0 1-4.813 4.813h-86.636a4.813 4.813 0 0 1 0-9.626h86.636a4.813 4.813 0 0 1 4.813 4.813" fill="#A3B4C6"></path><mask fill="#fff"></mask><path fill="#A3B4C6" mask="url(#d)" d="M154.098 190.096h70.513v-84.617h-70.513z"></path>
            ...
            <div className='features'>
                <Card title='Personalization'>Treating customers as individuals and acknowledging their preferences</Card>
                <Card title='Customer Feedback'>Requesting feedback. Ask for customer feedback regularly.</Card>
                <Card title='Rewarding Royality'> Offer special discounts, exclusive offers, or loyalty programs to encourage repeat business.</Card>
                <Card title='Communicate'>Great customer relationships are formed by communicating effectively.</Card>
            </div>
            <div className="subscribe">
                <Card title='Subscribe to our newsletter'>
                <Form onSubmitCapture={handleSubscribe} layout='vertical'>
                    <Form.Item 
                        hasFeedback
                        label="Full Name"
                        name="Full Name"
